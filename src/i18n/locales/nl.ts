...
const nl: Dictionary = {
  ...
  events: {
    ...
    items: [
      ...
      { category: 'Actueel', date: '21 juni – 23 augustus 2026', endDate: '2026-08-23', title: 'Zondagsbuffet bij Bjorliheimen Fjellhotell', intro: 'Bjorliheimen Fjellhotell nodigt uit voor het zondagsbuffet van zondag 21 juni tot en met zondag 23 augustus 2026. Elke zondag geopend van 13:00 tot 17:00 uur. Meer info: www.bjorliheimen.no' },
      { category: 'Evenement', date: '31 juli – 7 augustus 2026', endDate: '2026-08-07', title: 'Landsskytterstevnet 2026 in Lesja', intro: 'Landsskytterstevnet 2026, het Noorse nationale schietkampioenschap, vindt van 31 juli tot 7 augustus plaats in Lesja. Het wordt een van de grote regionale zomerhoogtepunten, met schutters, publiek en activiteit rond schietbaan Vidflotten. Bjorli is een goed uitvalsbasis voor bezoekers die het evenement willen combineren met bergen, activiteiten en overnachting in de omgeving.', imageAlt: 'Publiek en mensenmassa bij Landsskytterstevnet met arena, groot scherm en bergen op de achtergrond.', ctaLabel: 'Naar LS2026', ctaUrl: 'https://www.ls2026.no/' },
      { category: 'Actueel', date: '5–6 september 2026', endDate: '2026-09-06', title: 'Najaarsmarkt op Bjorli 2026', intro: 'De traditionele najaarsmarkt op Bjorli vindt ook dit jaar plaats in het weekend van 5–6 september 2026. Net als voorgaande jaren wordt het een levendig weekend op Bjorli met veel exposanten en mooie aanbiedingen.' },
      { category: 'Seizoensopening', date: 'Nov', title: 'Openingsweekend', intro: 'We vieren de start van het seizoen met aanbiedingen, activiteiten en après-ski.', status: 'unpublished' },
      { category: 'Familie', date: 'Feb', title: 'Voorjaarsvakantie', intro: 'Activiteiten voor jong en oud tijdens de voorjaarsvakantie.', status: 'unpublished' },
      { category: 'Pasen', date: 'Apr', title: 'Pasen op Bjorli', intro: 'Zon, sneeuw en gezinsactiviteiten op de berg.', status: 'unpublished' },
      {
        category: 'Actueel',
    ...
    items: [
      {
        ...
        body: 'Early Bird komt eraan.\n\nVan 4 tot en met 20 september krijg je de beste seizoenkaartprijzen van het jaar op Bjorli. Weet je nu al dat je deze winter bij ons skiet? Dan is dit hét moment, voordat de prijzen omhooggaan.\n\nEarly Bird koop je uitsluitend online op bjorli.no, van 4 tot en met 20 september. Bij de kassa in het skigebied is de actie niet beschikbaar, ook niet vooraf.',
        image: earlyBirdImg,
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Wat kan ik in de zomer in Bjorli doen?', a: 'Zomer in Bjorli betekent wandelen, fietsen, gezinsactiviteiten en natuurervaringen in Gudbrandsdalen en Romsdalen – met Trollveggen, Trollstigen, het Geirangerfjord, Ålesund en Dovrefjell binnen handbereik.' },
  ...
  footer: {
    ...
    address: 'Bjorliveien 84, 2669 Bjorli, Noorwegen',
  ...
  listing: {
    ...
    eventsArchiveTitle: 'Afgelopen evenementen',
    eventsArchiveIntro: 'Evenementen in Bjorli en omgeving die voorbij zijn. De pagina’s blijven online, zodat oude links blijven werken.',
    eventsArchiveLink: 'Bekijk afgelopen evenementen',
    eventEndedLabel: 'Afgelopen',
    eventsArchiveEmpty: 'Nog geen evenementen in het archief.',
    ...
    seoPlaceholderBody: 'Bjorli is een bergbestemming voor het hele jaar boven in Gudbrandsdalen, aan de grens met Romsdalen, tussen Oost- en Noordwest-Noorwegen. Met drie nationale parken, de Raumalijn, sneeuwzekere omstandigheden en korte afstanden tot de Rauma-rivier, Trollveggen, Trollstigen, het Geirangerfjord, Ålesund en Dovrefjell is Bjorli een natuurlijk vertrekpunt voor zowel een winter- als een zomervakantie.',
