...
const en: Dictionary = {
  ...
  events: {
    ...
    items: [
      ...
      { category: 'Season opening', date: 'Nov', title: 'Opening weekend', intro: 'We mark the season start with deals, activities and après-ski.', status: 'archived' },
