...
const en: Dictionary = {
  ...
  events: {
    ...
    items: [
      ...
      { category: 'News', date: '21 June – 23 August 2026', endDate: '2026-08-23', title: 'Sunday buffet at Bjorliheimen Fjellhotell', intro: 'Bjorliheimen Fjellhotell hosts a Sunday buffet from Sunday 21 June through Sunday 23 August 2026. Open every Sunday from 13:00 to 17:00. More info: www.bjorliheimen.no' },
      { category: 'Event', date: '31 July – 7 August 2026', endDate: '2026-08-07', title: 'Landsskytterstevnet 2026 in Lesja', intro: 'Landsskytterstevnet 2026, the Norwegian national shooting championships, is held in Lesja from 31 July to 7 August. It will be one of the summer’s big regional highlights, with shooters, spectators and activity around the Vidflotten range. Bjorli is a relevant base for visitors who want to combine the event with mountains, activities and lodging in the area.', imageAlt: 'Crowds and spectators at Landsskytterstevnet with arena, big screen and mountains in the background.', ctaLabel: 'See LS2026', ctaUrl: 'https://www.ls2026.no/' },
      { category: 'News', date: '5–6 September 2026', endDate: '2026-09-06', title: 'Høstmarked at Bjorli 2026', intro: 'The traditional autumn market at Bjorli returns the weekend of 5–6 September 2026. As in previous years, expect a lively weekend on Bjorli with many exhibitors and good deals.' },
      { category: 'Season opening', date: 'Nov', title: 'Opening weekend', intro: 'We mark the season start with deals, activities and après-ski.', status: 'unpublished' },
      { category: 'Family', date: 'Feb', title: 'Winter break programme', intro: 'Activities for kids and adults throughout the winter holiday week.', status: 'unpublished' },
      { category: 'Easter', date: 'Apr', title: 'Easter at Bjorli', intro: 'Sun, snow and family activities on the mountain.', status: 'unpublished' },
      {
        category: 'News',
  ...
  news: {
    ...
    items: [
      ...
      { category: 'Summer', date: 'May', title: 'Summer programme launched', intro: 'See what you can experience in Bjorli during the summer months.', status: 'unpublished' },
    ],
  },
  faq: {
  ...
  listing: {
    ...
    eventsArchiveIntro: 'Events at Bjorli and nearby that have finished. The pages stay online so older links keep working.',
    eventsArchiveLink: 'See past events',
    eventEndedLabel: 'Ended',
    eventsArchiveEmpty: 'No events in the archive yet.',
