...
const sv: Dictionary = {
  ...
  events: {
    ...
    items: [
      ...
      { category: 'Aktuellt', date: '21 juni – 23 augusti 2026', endDate: '2026-08-23', title: 'Söndagsbuffé på Bjorliheimen Fjellhotell', intro: 'Bjorliheimen Fjellhotell bjuder in till söndagsbuffé från söndag 21 juni till och med söndag 23 augusti 2026. Öppet varje söndag kl. 13:00–17:00. Mer info: www.bjorliheimen.no' },
      { category: 'Evenemang', date: '31 juli – 7 augusti 2026', endDate: '2026-08-07', title: 'Landsskytterstevnet 2026 på Lesja', intro: 'Landsskytterstevnet 2026 arrangeras på Lesja från 31 juli till 7 augusti. Det blir en av sommarens stora regionala höjdpunkter, med skyttar, publik och aktivitet vid Vidflotten skjutbana. Bjorli är en relevant utgångspunkt för besökare som vill kombinera stämman med fjäll, aktiviteter och boende i området.', imageAlt: 'Folkliv och publik under Landsskytterstevnet med arena, storbildsskärm och fjäll i bakgrunden.', ctaLabel: 'Se LS2026', ctaUrl: 'https://www.ls2026.no/' },
      { category: 'Aktuellt', date: '5–6 september 2026', endDate: '2026-09-06', title: 'Höstmarknad på Bjorli 2026', intro: 'Den traditionsrika höstmarknaden på Bjorli arrangeras även i år helgen 5–6 september 2026. Liksom tidigare år blir det liv och rörelse på Bjorli, med många spännande utställare och bra erbjudanden.' },
      { category: 'Säsongsöppning', date: 'Nov', title: 'Öppningshelg', intro: 'Vi firar säsongsstart med erbjudanden, aktiviteter och afterski.', status: 'unpublished' },
      { category: 'Familj', date: 'Feb', title: 'Sportlovsprogram', intro: 'Aktiviteter för stora och små under hela sportlovet.', status: 'unpublished' },
      { category: 'Påsk', date: 'Apr', title: 'Påsk på Bjorli', intro: 'Sol, snö och familjeaktiviteter på fjället.', status: 'unpublished' },
      {
        category: 'Aktuellt',
  ...
  listing: {
    ...
    eventsArchiveTitle: 'Tidigare evenemang',
    eventsArchiveIntro: 'Evenemang på Bjorli och i området som är avslutade. Sidorna ligger kvar så att gamla länkar fortsätter fungera.',
    eventsArchiveLink: 'Se tidigare evenemang',
    eventEndedLabel: 'Avslutat',
    eventsArchiveEmpty: 'Inga evenemang i arkivet än.',
