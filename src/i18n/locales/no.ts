...
const no: Dictionary = {
  ...
  events: {
    ...
    items: [
      ...
      { category: 'Aktuelt', date: '21. juni – 23. august 2026', endDate: '2026-08-23', title: 'Søndagsbuffet på Bjorliheimen Fjellhotell', intro: 'Bjorliheimen Fjellhotell inviterer til søndagsbuffet fra og med søndag 21. juni til og med søndag 23. august 2026. Buffeten er åpen hver søndag kl. 13:00–17:00. Mer info: www.bjorliheimen.no' },
      { category: 'Arrangement', date: '31. juli – 7. august 2026', endDate: '2026-08-07', title: 'Landsskytterstevnet 2026 på Lesja', intro: 'Landsskytterstevnet 2026 arrangeres på Lesja fra 31. juli til 7. august. Dette blir et av sommerens store regionale høydepunkter, med skyttere, publikum og aktivitet ved Vidflotten skytebane. Bjorli er et relevant utgangspunkt for besøkende som vil kombinere stevnet med fjell, aktiviteter og overnatting i området.', imageAlt: 'Folkeliv og publikum under Landsskytterstevnet med arena, storskjerm og fjell i bakgrunnen.', ctaLabel: 'Se LS2026', ctaUrl: 'https://www.ls2026.no/' },
      { category: 'Aktuelt', date: '5.–6. september 2026', endDate: '2026-09-06', title: 'Høstmarked på Bjorli 2026', intro: 'Det tradisjonsrike høstmarkedet på Bjorli arrangeres også i år helgen 5.–6. september 2026. Som tidligere år blir det liv og røre på Bjorli, med mange spennende utstillere og gode tilbud.' },
      { category: 'Sesongåpning', date: 'Nov', title: 'Åpningshelg', intro: 'Vi markerer sesongstart med tilbud, aktiviteter og afterski.', status: 'unpublished' },
      { category: 'Familie', date: 'Feb', title: 'Vinterferieprogram', intro: 'Aktiviteter for store og små gjennom hele vinterferien.', status: 'unpublished' },
      { category: 'Påske', date: 'Apr', title: 'Påske på Bjorli', intro: 'Sol, snø og familieaktiviteter på fjellet.', status: 'unpublished' },
      {
        category: 'Aktuelt',
  ...
  listing: {
    ...
    eventsArchiveTitle: 'Tidligere arrangementer',
    eventsArchiveIntro: 'Arrangementer på Bjorli og i området som er avsluttet. Sidene ligger åpne, så gamle lenker fortsatt virker.',
    eventsArchiveLink: 'Se tidligere arrangementer',
    eventEndedLabel: 'Avsluttet',
    eventsArchiveEmpty: 'Ingen arrangementer i arkivet ennå.',
