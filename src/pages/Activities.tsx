...
const buildSections = (
  ...
  },
  {
    ...
    cards: [
      ...
      { key: 'tafjord', title: c.tafjord.t, desc: c.tafjord.d, href: '/sommer/tafjordfjella', image: tafjordfjellaImg, alt: 'Tafjordfjella med fjell, vann og høstfarger.' },
    ],
  },
  {
...
const COPY_RAW = {
  ...
  sv: {
    ...
    luftigeTitle: 'Luftiga upplevelser och lokala aktörer',
    luftigeIntro: 'Specialiserade lokala aktörer i och runt Bjorli.',
    flyplass: {
      t: 'Bjorli Flygplats och Lesja Fallskärmsklubb',
