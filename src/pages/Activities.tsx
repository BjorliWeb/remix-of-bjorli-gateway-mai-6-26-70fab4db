...
const COPY_RAW = {
  no: {
    ...
    klatring: { t: 'Klatring og buldring', d: 'Sportsklatring, buldring, via ferrata og alpine opplevelser i Romsdalen. Bjorli som basecamp mellom fjell, elv og fjord.', alt: 'Dramatiske granittvegger i Romsdalen — klatring og buldring' },
  ...
  en: {
    ...
    klatring: { t: 'Climbing and bouldering', d: 'Sport climbing, bouldering, via ferrata and alpine experiences in Romsdalen. Bjorli as a basecamp between mountains, river and fjord.', alt: 'Dramatic granite walls in Romsdalen — climbing and bouldering' },
  ...
  de: {
    ...
    klatring: { t: 'Klettern und Bouldern', d: 'Sportklettern, Bouldern, Via Ferrata und alpine Erlebnisse im Romsdalen. Bjorli als Basislager zwischen Bergen, Fluss und Fjord.', alt: 'Dramatische Granitwände im Romsdalen — Klettern und Bouldern' },
  ...
  nl: {
    ...
    klatring: { t: 'Klimmen en boulderen', d: 'Sportklimmen, boulderen, via ferrata en alpine ervaringen in Romsdalen. Bjorli als basiskamp tussen bergen, rivier en fjord.', alt: 'Dramatische granietwanden in Romsdalen — klimmen en boulderen' },
  ...
  da: {
    ...
    klatring: { t: 'Klatring og bouldering', d: 'Sportsklatring, bouldering, via ferrata og alpine oplevelser i Romsdalen. Bjorli som basislejr mellem fjeld, elv og fjord.', alt: 'Dramatiske granitvægge i Romsdalen — klatring og bouldering' },
  ...
  sv: {
    ...
    klatring: { t: 'Klättring och bouldering', d: 'Sportklättring, bouldering, via ferrata och alpina upplevelser i Romsdalen. Bjorli som basläger mellan fjäll, älv och fjord.', alt: 'Dramatiska granitväggar i Romsdalen — klättring och bouldering' },
