...
// Removed: legacy const providers/bookingTips/relatedLinks replaced by COPY-driven data.
const _LEGACY_REMOVED: never[] = [];
const __unused_providers: never[] = [];

// Backwards-compatible references kept to satisfy any external imports (none).
const __removed_unused = [
  {
    name: 'Novasol',
