...
const COPY: Record<'no' | 'en' | 'de' | 'nl' | 'da' | 'sv', Copy> = {
  no: {
    ...
    introP1: 'Sagelva vasskraftsenter ligger på Stueflotten øverst i Gudbrandsdalen, like ved Bjorli i Lesja kommune. Her kan du oppleve hvordan vatnet frå Asbjørnsåa har gitt kraft til sag, kvern og vadmelstampe i tre hundre år — og hvordan det fortsatt gjør det i dag.',
    ...
    cards: [
      ...
      { title: 'Lokal historie', desc: '300 år med vasskraft på Stueflotten øverst i Gudbrandsdalen — bygd opp av lokale ildsjeler og tildelt Olavsrosa fra Norsk kulturarv i 2020.', alt: 'Anlegget på Sagelva i furuskogen i Lesja' },
  ...
  en: {
    ...
    introP1: 'Sagelva vasskraftsenter sits at Stueflotten at the top of Gudbrandsdalen, just by Bjorli in Lesja municipality. Here you can see how water from the Asbjørnsåa river has powered a sawmill, mill and fulling stamp for three hundred years — and still does today.',
    ...
    cards: [
      ...
      { title: 'Local history', desc: '300 years of water power at Stueflotten at the head of Gudbrandsdalen — built by local volunteers and awarded Olavsrosa by Norsk kulturarv in 2020.', alt: 'The Sagelva site among the pine forest in Lesja' },
  ...
  de: {
    ...
    introP1: 'Sagelva vasskraftsenter liegt auf Stueflotten am oberen Ende von Gudbrandsdalen, direkt bei Bjorli in der Kommune Lesja. Hier sehen Sie, wie Wasser aus der Asbjørnsåa seit dreihundert Jahren Säge, Mühle und Walkstampfe antreibt — und es bis heute tut.',
    ...
    cards: [
      ...
      { title: 'Lokale Geschichte', desc: '300 Jahre Wasserkraft auf Stueflotten am oberen Ende von Gudbrandsdalen — aufgebaut von Einheimischen, 2020 mit der Olavsrose von Norsk kulturarv ausgezeichnet.', alt: 'Die Anlage von Sagelva im Kiefernwald in Lesja' },
  ...
  nl: {
    ...
    introP1: 'Sagelva vasskraftsenter ligt op Stueflotten bovenin Gudbrandsdalen, vlak bij Bjorli in de gemeente Lesja. Hier zie je hoe water uit de Asbjørnsåa al drie eeuwen lang zaagmolen, korenmolen en voldermolen aandrijft — en dat vandaag nog steeds doet.',
    ...
    cards: [
      ...
      { title: 'Lokale geschiedenis', desc: '300 jaar waterkracht op Stueflotten bovenin Gudbrandsdalen — opgebouwd door lokale vrijwilligers en in 2020 bekroond met de Olavsroos van Norsk kulturarv.', alt: 'De site van Sagelva in het dennenbos in Lesja' },
  ...
  da: {
    ...
    introP1: 'Sagelva vasskraftsenter ligger på Stueflotten øverst i Gudbrandsdalen, lige ved Bjorli i Lesja kommune. Her kan du opleve, hvordan vand fra Asbjørnsåa har givet kraft til sav, mølle og vadmelstampe i tre hundrede år — og hvordan det stadig gør det i dag.',
    ...
    cards: [
      ...
      { title: 'Lokal historie', desc: '300 års vandkraft på Stueflotten øverst i Gudbrandsdalen — bygget op af lokale ildsjæle og tildelt Olavsrosa af Norsk kulturarv i 2020.', alt: 'Anlægget ved Sagelva i fyrreskoven i Lesja' },
  ...
  sv: {
    ...
    introP1: 'Sagelva vasskraftsenter ligger på Stueflotten överst i Gudbrandsdalen, alldeles intill Bjorli i Lesja kommun. Här ser du hur vatten från Asbjørnsåa drivit såg, kvarn och valkstamp i tre hundra år — och fortfarande gör det i dag.',
    ...
    cards: [
      ...
      { title: 'Lokal historia', desc: '300 år av vattenkraft på Stueflotten överst i Gudbrandsdalen — uppbyggd av lokala eldsjälar och tilldelad Olavsrosa av Norsk kulturarv 2020.', alt: 'Anläggningen vid Sagelva i tallskogen i Lesja' },
