...
/**
 * Sub-page content without image assets.
 *
 * This module is imported both by the browser bundle (which adds Vite-
 * resolved hero images in subpages.ts) and by the prerender script, so the
 * same text/links/FAQ data is used everywhere.
 */
...
const NO: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    ...
    body: 'Heiskort på Bjorli gir deg tilgang til snøsikre nedfarter midt mellom Dombås og Åndalsnes. Vi anbefaler å kjøpe heiskort online før du kommer – da slipper du kø i billettluka og kan gå rett i heisen. Barn 0–6 år kjører gratis og trenger ikke eget Keycard.',
    heroImageAlt: 'Heiser og nedfarter på Bjorli',
    highlights: [
      ...
      { title: 'Barn 0–6 år gratis', desc: 'Barn 0–6 år kjører gratis og trenger ikke eget Keycard.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Kjører barn gratis?', a: 'Barn 0–6 år kjører gratis og trenger ikke eget Keycard.' },
      { q: 'Trenger alle eget heiskort?', a: 'Alle som skal bruke heisene må ha gyldig heiskort. Barn 0–6 år kjører gratis og trenger ikke eget Keycard.' },
    ],
    seoTitle: 'Heiskort Bjorli – kjøp dagskort, flerdagskort og sesongkort',
    seoDescription: 'Kjøp heiskort til Bjorli Skisenter online – snøsikre nedfarter og enkel adgang til heisene. Barn 0–6 år kjører gratis. Dagskort, flerdagskort og sesongkort.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Langrennsløyper på Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Fotturer i fjellet rundt Bjorli',
    highlights: [
  ...
  sykling: {
    ...
    heroImageAlt: 'Sykling på Bjorli',
    highlights: [
  ...
  familie: {
    ...
    heroImageAlt: 'Familie på Bjorli',
    highlights: [
  ...
  live: {
    ...
    heroImageAlt: 'Live status fra Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Løypekart for Bjorli',
    highlights: [
...
const EN: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    ...
    body: 'A lift pass at Bjorli gives you access to snow-sure slopes between Dombås and Åndalsnes. Buying online before you arrive saves time at the ticket office and lets you head straight for the lifts. Children aged 0–6 ski free and do not need their own Keycard.',
    heroImageAlt: 'Lifts and slopes at Bjorli',
    highlights: [
      ...
      { title: 'Children 0–6 ski free', desc: 'Children aged 0–6 ski free and do not need their own Keycard.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Do children ski free?', a: 'Children aged 0–6 ski free and do not need their own Keycard.' },
      { q: 'Does everyone need their own pass?', a: 'Everyone using the lifts needs a valid lift pass. Children aged 0–6 ski free and do not need their own Keycard.' },
    ],
    seoTitle: 'Bjorli lift passes – day, multi-day and season passes',
    seoDescription: 'Buy lift passes for Bjorli Skisenter online – snow-sure slopes and easy lift access. Children aged 0–6 ski free. Day, multi-day and season passes.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Cross-country trails at Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Hiking in the mountains around Bjorli',
    highlights: [
  ...
  sykling: {
    ...
    heroImageAlt: 'Cycling at Bjorli',
    highlights: [
  ...
  familie: {
    ...
    heroImageAlt: 'A family at Bjorli',
    highlights: [
  ...
  live: {
    ...
    heroImageAlt: 'Live status from Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Trail map for Bjorli',
    highlights: [
...
const DE: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    ...
    highlights: [
      ...
      { title: 'Kinder 0–6 Jahre gratis', desc: 'Kinder von 0 bis 6 Jahren fahren kostenlos und benötigen keine eigene Keycard.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Fahren Kinder kostenlos?', a: 'Kinder von 0 bis 6 Jahren fahren kostenlos und benötigen keine eigene Keycard.' },
      { q: 'Braucht jede Person einen eigenen Skipass?', a: 'Alle, die die Lifte benutzen, benötigen einen gültigen Skipass. Kinder von 0 bis 6 Jahren fahren kostenlos und benötigen keine eigene Keycard.' },
    ],
    seoTitle: 'Skipass Bjorli – Tages-, Mehrtages- und Saisonpässe',
    seoDescription: 'Skipässe für Bjorli Skisenter online kaufen – schneesichere Pisten und einfacher Liftzugang. Kinder von 0 bis 6 Jahren fahren kostenlos. Tages-, Mehrtages- und Saisonpässe.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Langlaufloipen in Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Wandern im Berggebiet um Bjorli',
    highlights: [
  ...
  sykling: {
    ...
    heroImageAlt: 'Radfahren in Bjorli',
    highlights: [
  ...
  familie: {
    ...
    heroImageAlt: 'Familie in Bjorli',
    highlights: [
  ...
  live: {
    ...
    heroImageAlt: 'Live-Status aus Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Loipenplan für Bjorli',
    highlights: [
...
const NL: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    ...
    body: 'Een skipas op Bjorli geeft je toegang tot sneeuwzekere pistes tussen Dombås en Åndalsnes. We raden aan om je skipas online te kopen voordat je komt – zo sta je niet in de rij en kun je direct naar de lift. Kinderen van 0 tot en met 6 jaar skiën gratis en hebben geen eigen Keycard nodig.',
    heroImageAlt: 'Liften en pistes op Bjorli',
    highlights: [
      ...
      { title: 'Kinderen 0–6 jaar gratis', desc: 'Kinderen van 0 tot en met 6 jaar skiën gratis en hebben geen eigen Keycard nodig.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Skiën kinderen gratis?', a: 'Kinderen van 0 tot en met 6 jaar skiën gratis en hebben geen eigen Keycard nodig.' },
      { q: 'Heeft iedereen een eigen skipas nodig?', a: 'Iedereen die de liften gebruikt heeft een geldige skipas nodig. Kinderen van 0 tot en met 6 jaar skiën gratis en hebben geen eigen Keycard nodig.' },
    ],
    seoTitle: 'Skipassen Bjorli – koop dag-, meerdaagse en seizoenpassen',
    seoDescription: 'Koop skipassen voor Bjorli Skisenter online – sneeuwzekere pistes en eenvoudige toegang tot de liften. Kinderen van 0 tot en met 6 jaar skiën gratis. Dag-, meerdaagse en seizoenpassen.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Langlaufloipes op Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Wandelen in de bergen rond Bjorli',
    highlights: [
  ...
  sykling: {
    ...
    heroImageAlt: 'Fietsen op Bjorli',
    highlights: [
  ...
  live: {
    ...
    heroImageAlt: 'Live status vanaf Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Pistekaart voor Bjorli',
    highlights: [
...
const DA: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    ...
    body: 'Et liftkort på Bjorli giver dig adgang til snesikre pister mellem Dombås og Åndalsnes. Vi anbefaler at købe liftkortet online inden ankomst – så slipper du for kø i billetlugen og kan gå direkte til liften. Børn fra 0 til og med 6 år kører gratis og skal ikke have deres eget Keycard.',
    heroImageAlt: 'Lifte og pister på Bjorli',
    highlights: [
      ...
      { title: 'Børn 0–6 år gratis', desc: 'Børn fra 0 til og med 6 år kører gratis og skal ikke have deres eget Keycard.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Kører børn gratis?', a: 'Børn fra 0 til og med 6 år kører gratis og skal ikke have deres eget Keycard.' },
      { q: 'Skal alle have eget liftkort?', a: 'Alle der skal bruge lifterne, skal have et gyldigt liftkort. Børn fra 0 til og med 6 år kører gratis og skal ikke have deres eget Keycard.' },
    ],
    seoTitle: 'Liftkort Bjorli – køb dagskort, flerdagskort og sæsonkort',
    seoDescription: 'Køb liftkort til Bjorli Skisenter online – snesikre pister og nem adgang til lifterne. Børn fra 0 til og med 6 år kører gratis. Dagskort, flerdagskort og sæsonkort.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Langrendsspor på Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Vandring i fjeldet omkring Bjorli',
    highlights: [
  ...
  sykling: {
    ...
    heroImageAlt: 'Cykling på Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Løjpekort for Bjorli',
    highlights: [
...
const SV: Record<SubPageSlug, SubPageContent> = {
  heiskort: {
    slug: 'heiskort', language: 'sv',
    title: 'Liftkort på Bjorli',
    intro: 'Liftkort till Bjorli Skisenter – dagskort, flerdagarskort och säsongskort för hela familjen.',
    body: 'Ett liftkort på Bjorli ger dig tillgång till snösäkra backar mellan Dombås och Åndalsnes. Vi rekommenderar att köpa liftkortet online innan du kommer – då slipper du köa i biljettluckan och kan gå direkt till liften. Barn 0–6 år åker gratis och behöver inget eget Keycard.',
    heroImageAlt: 'Liftar och backar på Bjorli',
    highlights: [
      ...
      { title: 'Barn 0–6 år gratis', desc: 'Barn 0–6 år åker gratis och behöver inget eget Keycard.', icon: 'users' },
    ],
    ctas: [
    ...
    faq: [
      ...
      { q: 'Åker barn gratis?', a: 'Barn 0–6 år åker gratis och behöver inget eget Keycard.' },
      { q: 'Behöver alla ett eget liftkort?', a: 'Alla som ska använda liftarna behöver ett giltigt liftkort. Barn 0–6 år åker gratis och behöver inget eget Keycard.' },
    ],
    seoTitle: 'Liftkort Bjorli – köp dagskort, flerdagarskort och säsongskort',
    seoDescription: 'Köp liftkort till Bjorli Skisenter online – snösäkra backar och enkel åtkomst till liftarna. Barn 0–6 år åker gratis. Dagskort, flerdagarskort och säsongskort.',
  },
  langrenn: {
    ...
    heroImageAlt: 'Längdspår på Bjorli',
    highlights: [
  ...
  fotturer: {
    ...
    heroImageAlt: 'Vandring i fjället runt Bjorli',
    highlights: [
  ...
  live: {
    ...
    heroImageAlt: 'Live-status från Bjorli',
    highlights: [
  ...
  loypekart: {
    ...
    heroImageAlt: 'Spårkarta för Bjorli',
    highlights: [
...
export const SUBPAGES: Record<Language, Record<SubPageSlug, SubPageContent>> = {
  no: NO,
  en: EN,
  de: DE,
  nl: NL,
