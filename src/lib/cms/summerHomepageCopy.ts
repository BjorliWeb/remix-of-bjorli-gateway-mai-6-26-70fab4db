...
export const SUMMER_HOMEPAGE_COPY: Record<Language, SummerHomepageCopy> = {
  no: {
    intro: {
      ...
      subtitle:
        'Bjorli ligger midt mellom fjordene, nasjonalparkene og noen av Norges mest kjente naturopplevelser — med god plass og rolig tempo.',
      items: [
        { title: 'Fjellro',      desc: 'God plass, ren luft og en roligere fjellopplevelse.' },
        { title: 'Aktive dager', desc: 'Stier, sykkel, fiske, turer og familievennlige opplevelser.' },
        { title: 'Basecamp',     desc: 'Bo på Bjorli og bruk dagene mellom fjell, daler og fjordlandskap.' },
      ],
    },
    activitiesGrid: {
      eyebrow: 'Sommer på Bjorli',
      ...
      cards: [
        ...
        { title: 'Fiske', desc: 'Fluefiske i Rauma, elvefiske og rolige dager ved fjellvannene rundt Bjorli.', alt: 'Fluefiske i en fjellelv nær Bjorli en stille sommerdag' },
        ...
        { title: 'Natur og utsikt', desc: 'Åpne vidder, fjellplatåer og stille seterdaler i tre nasjonalparker like ved.', alt: 'Åpent sommerlandskap nær Bjorli' },
        { title: 'Dagsturer fra Bjorli', desc: 'Romsdalen, Trollstigen, Geirangerområdet og Åndalsnes innen kort kjøretur eller togtur.', alt: 'Raumabanen langs elvedalen — regional dagstur fra Bjorli' },
      ],
    },
    biking: {
